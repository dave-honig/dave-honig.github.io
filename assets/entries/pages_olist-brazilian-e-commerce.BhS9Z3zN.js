...
.readme hr.finding-end { width: 75%; margin: 1em auto 1em; border-top: 1px solid rgb(24, 58, 140); }
...
<li>Averages diverge much further at R$28.15 for 1-star and R$21.71 for 5-star orders. The 1-star average in being increased by expensive outliers at a higher rate than 5-star orders.</li>
</ul>
...
`,className:"w-html-embed"}),e.jsx("hr",{className:"w-element c1w2kby2 c1xo2ua8 c1u4qrj5 c1qiyaxo cdp8qbu cuilavn c72v0tn c6qujbi c3czewo"})]})]})})}),e.jsx(p,{children:e.jsx(g,{children:e.jsxs("div",{className:"w-element c19e299d",children:[e.jsx("p",{className:"w-element c7tji72 c1stfoor cf1e8cd csd6brl c1atcgj0 caf51ll c195fktj c1qgnt61 c8haaz7",children:"© 2026 David Honig. All rights reserved."}),e.jsx("hr",{className:"w-element c1w2kby2 c3w2odz ccktdsi c23gqnr cyly4zz c5vp848 c11l18sm"})]})})})]}),L=t=>{const{origin:a,pathname:o,search:r}=new URL(t);return`${a}${o}${r}`},$=x.memo(({pageKey:t,system:a})=>e.jsx(R,{system:a},t),(t,a)=>t.pageKey===a.pageKey),I=({data:t})=>{const{system:a,resources:o,url:r,pageMeta:f}=t,_=L(r),k=x.useMemo(()=>({imageLoader:u,assetBaseUrl:n,resources:o,breakpoints:C,onError:console.error}),[o]);return e.jsxs(S.Provider,{value:k,children:[e.jsx(T.Provider,{value:r,children:e.jsx($,{pageKey:_,system:a})}),e.jsx(O,{url:r,pageMeta:f,siteName:j,imageLoader:u,assetBaseUrl:n}),e.jsx(P,{children:f.title})]})},H=Object.freeze(Object.defineProperty({__proto__:null,default:I},Symbol.toStringTag,{value:"Module"})),Q=({})=>{const t={"@context":"https://schema.org","@type":"WebSite",name:j};return e.jsxs(e.Fragment,{children:[e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(t,null,2)}}),e.jsx("link",{rel:"icon",href:u({src:`${n}${A}`})}),D.map(a=>e.jsx("link",{rel:"preload",href:`${n}${a}`,as:"font",crossOrigin:"anonymous"},a)),B.map(a=>e.jsx("link",{rel:"preload",href:`${n}${a}`,as:"image"},a))]})},M=Object.freeze(Object.defineProperty({__proto__:null,Head:Q},Symbol.toStringTag,{value:"Module"})),F={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"/renderer/+onRenderClient.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:E}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/olist-brazilian-e-commerce/+Page.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:H}},Head:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/olist-brazilian-e-commerce/+Head.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:M}}};export{F as configValuesSerialized};
